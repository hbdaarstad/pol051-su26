...
::: callout-important
Project Presentation date moved forward, now Mon. July 27

Note: The project is subject to changes throughout the course, so please refer to the instructor's comments for any changes made as the course continues.
:::

## Timeline

[Project Proposal](#topic-ideas) due ~~Sun, June 28~~ Wed. July 1
...
[Presentation](#video-presentation--slides) on ~~Thu, July 30~~ Mon. July 27

## Introduction

*Make a Research Question, Pick a data set, and do analysis. That is your final project.*

The goal of the final project is for you to apply the skills you have been learning throughout the quarter and apply them to real-life data to answer a question YOU HAVE MADE.
...
-   The original quarto file with the code

## Project Proposal {#topic-ideas}

I have curated a list of data sets on a range of topics including sports, tipping, exposure to violence, gender, environmental topics, global attitudes, and more.

As a group, select a data set that you are interested in and that relates to your research question. You will be required to submit your group's research question and the selected data set.

Find the data sets [here](project-tips-resources.qmd).

### Project Proposal submission

Your Project Proposal submission should be no more than half a page and will be graded on completion. This means that as long as you attempt, show that you tried, and included all requirements then you will receive full credit.

Download the template [here](files/project-proposal-template.qmd){download="project-proposal-template.qmd"}. Render as a Word document (.docx) and submit to Canvas.
...
-   State the source of the data set: who made the data?
    -   Remember to provide a citation for the data set
-   Describe the observations and the general characteristics being measured in the data
    ...
    -   Use the codebook to find what variables were collected and how they are measured.
...
-   In the template, show a glimpse of the selected variables that relate to your research question.

    -   Use the `read.csv()` to import the selected data set, make sure the selected data set is in your POL 051 folder.
    -   Then use the `select()` to select the specific variables you would like to use to answer your question
        -   Doesn't need to be your final selection but should be related to your question.
...
-   Use the `head` function to provide an overview of each data set
    ...
    # install.packages("tidyverse") if you have not installed tidyverse yet
    library(tidyverse)
    ...
    data <- read.csv("data_set_name.csv")
...
The purpose of the project report draft #1 is to get your team started on this project earlier, so you are not doing this last minute. This is graded on completion; as long as all parts are included, your group will receive full credit.

Click here for the [project report template](files/project-template.qmd){download="project-template.qmd"}.

You will render this as a Word document (.docx) before submitting to Canvas.
...
-   You should state the motivation of the research question
    -   Focus these two key elements:
        ...
        -   What does this contribute to?
            -   Does this contribute to more knowledge? (Intellectual)
...
Critically reviewing others' work is a crucial part of the scientific process. Each team will be assigned two other teams' projects to review. You will be randomly assigned two other teams' drafts and will need to provide detailed comments by Wed. July 22
...
-   For each of the columns, find the name of the team to review in the **Team being reviewed** column.
...
-   final_report_team-name.docx
    ...
    -   click here for the [template](files/project-template.qmd){download="project-template.qmd"}.

-   final_pres_team-name (in whatever format works for you!)
...
-   final_project_team-name.qmd
    ...
    -   The unrendered version of your project.
...
#### Introduction (10 points) (1/2 - 1 page)

The introduction will be worth 10 points and needs to include the following:

-   The Motivation/Significance (5 points)
...
#### Lit Review (10 points) (1-2 pages)

The lit review will be worth 10 points and needs to include the following:

-   A comprehensive review of the lit based on your topic (5 points)

    -   You need to cite a minimum of 5 academic articles

        -   You will lose 1 point for every article below the minimum

-   You need to address the gap: where does your question settle in the literature? (5 points)

    -   You do not need to provide a huge or original contribution, but just think about what answering your question adds that you think is missing.

#### Hypotheses (10 points) (1/2 page)

-   You need to include at least 1 hypothesis and it needs to be testable with the data you have selected

#### Data Description (10 points) (1/2 page)

-   description of the observations in the data set,

    -   What is your independent variable? (3 points)
        -   How was it measured? (1 point)
        -   How was it collected? (1 point)
    -   What is your dependent variable? (3 points)
        -   How was it measured? (1 point)

        -   How was it collected? (1 point)

#### Data Summary + Regression (50 points)

-   Data Summarization (15 points)

    -   Show and describe two different data visualizations (10 points/5 points each)

        -   Need to include titles, etc.

        -   Make it look nice

        -   Needs to make sense with the data being used.

    -   Description of averages, medians, etc. (5 points)

-   Regression Model (20 points)

    -   One simple regression model (10 points)

        -   One outcome and one independent variable

        -   A table of these results

    -   One multivariate regression model (10 points)

        -   One outcome, one independent variable, and controls (at least two)
...
| **Hypotheses**                | 10 pts  |
| **Data Description**          | 10 pts  |
| **Data Summary + Regression** | 50 pts  |
| **Conclusion**                | 10 pts  |

### Slides (25 points)

The final report will include a pdf version of the team's presentation of the project. For more information on the format for the presentation go to [Presentation].
...
IMPORTANT: NO TEAM MEMBER CAN BE SOLELY RESPONSIBLE FOR THE CODING
